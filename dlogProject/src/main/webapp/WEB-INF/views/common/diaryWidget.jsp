                    ...
                    <div class="text-center">
                    	...
                    	<c:choose>
                    		<c:when test="${empty friendInfo}">
                        		<img alt="" class="rounded-circle mt-4" src="${loginUser.profile }" width="90px" height="90px">
                     	 ...
                     	 <c:otherwise>
                        		<img alt="" class="rounded-circle mt-4" src="${friendInfo.profile }" width="90px" height="90px">
