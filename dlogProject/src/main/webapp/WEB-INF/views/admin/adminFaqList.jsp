                            ...
                            <div class="card" style="width:900px;">
                                ...
                                <!-- 여기다가 작성 -->
                                	<div id="faqUpdate">
				                		...
				                		<input class="btn btn-primary btn-sm" type="button" value="작성" onclick="location.href='enrollForm.fo';">
								            ...
								            <div class="modal-dialog">
								                <div class="modal-content">
								                    ...
								                    <div class="modal-body" align="center">
								                            ...
								                            <a href="#"  class="btn btn-danger" role="button" onclick="location.href='adminFaqList.fo';">취소</a>
       ...
       <script>
	       $(document).ready(function() {
		    		...
		    		$('#listTable td:not(:nth-child(1))').click(function(){
		    				...
		    				location.href="adminFaqDetail.no?bno=" + $(this).closest("td").siblings(".bno").text();
	     	...
	     	// delete
			  	...
			  	var arr=[];
			  	 $("#btnAgree").click(function(event) {
			  		...
			  		var array = arr.join();
			  		location.href="adminFaqDelete.no?array="+array;
